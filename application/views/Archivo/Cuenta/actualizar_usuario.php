<div align="center">
	<form id="modal_usuario" name="modal_usuario" action="<?php echo base_url()?>Archivo/Cuenta/crear_usuario" method="post" class="reset-this">
		<div class="col-md-10 col-sm-12 col-xs-12 form-group" id="nombre_div">
			<input type="text" name="nombre" id="nombre" class="form-control fondo-input" placeholder="Nombre" value="<?php echo $resultado; ?>"" style="height:100%; width:100%" readonly />
		</div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12 form-group" id="boton_div" align="right" style="padding:2% 0% 0% 0%;">
			...
			<input type="submit" name="submit" id="guardar" class="btn btn-verde" value="Actualizar"/>
		</div>
