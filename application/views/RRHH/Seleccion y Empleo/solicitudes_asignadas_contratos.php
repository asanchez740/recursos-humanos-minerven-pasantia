  ...
  <div class="row">
    <div align="center" style="padding:4% 0% 0% 0%;">
      ...
      <form action="#" method="post"  class="form" style="width: 94%;">
        ...
        <table id="seleccion_empleo_contrato" class="table table-bordered table-striped" style="font-size: 12px;" >
            <thead class="thead-dark">
              <tr class="encabezado-tablas">
                ...
                <th scope="col" style="font-size: 14px;color:white;background-color: #006699;width: 15%;">Estado</th>
                <th scope="col" style="font-size: 14px;color:white;background-color: #006699;width: 15%;text-align: center;">Acciones</th>
              </tr>
            </thead>
