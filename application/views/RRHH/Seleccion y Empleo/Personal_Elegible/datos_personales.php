...
<div class="inputs" align="left">
	<div class="col-md-3 col-sm-12 col-xs-12 form-group" id="cedula">
		<input type="text" name="cedula" id="txt_cedula" class="form-control fondo-input" placeholder="Cedula" style="width:100%">
	</div>
...
<div class="inputs" align="left">
	<div class="col-md-3 col-sm-12 col-xs-12 form-group" id="fecha_trab_div">			
		<input type="text" name="datepicker" id="datepicker" value="" placeholder="Fecha de Nacimiento"  readonly style="width:100%;height: 30px;padding-left: 5%">
	</div>
