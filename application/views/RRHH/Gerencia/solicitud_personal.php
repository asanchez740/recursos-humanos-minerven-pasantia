        ...
        <table id="gerencia_soliciud" class="table table-bordered table-striped" style="font-size: 12px;" >
            <thead class="thead-dark">
              <tr class="encabezado-tablas">
                ...
                <th scope="col" style="font-size: 14px;color:white;background-color: #006699;width: 10%;">Departamento</th>
                ...
                <th scope="col" style="font-size: 14px;color:white;background-color: #006699;width: 20%;" align="center">Acciones</th>
              </tr>
            </thead>
